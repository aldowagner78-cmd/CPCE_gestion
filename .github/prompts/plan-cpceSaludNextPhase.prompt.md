...
- [ ] Welcome page + botón Home global
- [ ] Sistema de roles y permisos (DB + middleware + UI)
- [ ] Dashboard expandido con KPIs reales
- [ ] Menú lateral dinámico por rol

### Fase 2 — Módulos Core (2-3 semanas)
- [ ] Prestadores `/providers`
- [ ] Autorizaciones `/authorizations` con workflow
- [ ] Estadísticas avanzadas `/stats`
- [ ] Integración del sistema de auditoría actual

### Fase 3 — Operaciones (2-3 semanas)
- [ ] Facturación y débitos `/billing`
- [ ] Coseguros y copagos `/copayments`
- [ ] Farmacia `/pharmacy`
- [ ] Reportes regulatorios `/reports`

### Fase 4 — Portal Externo (2 semanas)
- [ ] Portal del afiliado (credencial digital, trámites)
- [ ] Portal del prestador (facturas, autorizaciones)
- [ ] Mesa de ayuda `/support`

### Fase 5 — Inteligencia (1-2 semanas)
- [ ] Panel ejecutivo `/executive`
