...
const ALL_COMMANDS: CommandItem[] = [
    ...
    { id: 'buscador', label: 'Buscador de Prácticas', description: 'Buscar prácticas con normativa detallada', icon: Search, href: '/buscador', keywords: ['buscador', 'buscar', 'practica', 'normativa', 'incluye', 'excluye', 'requisitos', 'coseguro'], section: 'navegación', permission: 'nomenclators.view' },
