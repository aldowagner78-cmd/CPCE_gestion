...
const menuItems = [
    ...
    { icon: Target, label: 'Matcher', href: '/matcher' },
...
// Admin items
const adminItems = [
    { icon: FileText, label: 'Nom. Externos', href: '/practices/external', permission: 'nomenclators.view' },
...
export function Sidebar() {
    ...
    return (
        <>
            ...
            <div className={cn(
                "fixed inset-y-0 left-0 z-40 w-64 bg-card border-r shadow-sm transform transition-transform duration-300 ease-in-out md:translate-x-0 flex flex-col",
